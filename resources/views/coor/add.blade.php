        ...
        <nav class="w-full hidden sm:flex justify-between items-center p-3 transition-all ease-in-out nav absolute top-0">
            <div class="flex items-center">
                <div class="pr-3 border-r border-gray-300">
                    <Link class="text-xs0 flex items-center justify-center gap-3 blue-btn squared-btn border-2" href="{{ route('subjectlist.index') }}">
    ...
    <div class="flex flex-wrap items-center justify-center sm:w-tabw w-full h-fit gap-5 sm:p-20">
        <div class="bg-white sm:rounded-xl relative sm:shadow-md w-full h-full flex flex-col">
            <div class="sm:hidden flex items-start p-5 h-fit transition-all ease-in-out navback">
                <Link class="text-xs0 flex items-center justify-center gap-2" href="{{ route('subjectlist.index') }}">
                    <i class=" fa-solid fa-book"></i>
                    <p class="text-center">Subjects</p>
                </Link>
            </div>
            ...
            <div class="sm:hidden">
                <div class="bg-b6 w-full p-3 flex sm:px-5 items-center justify-center">
                    <p class="text-white sm:text-lg text-sm font-normal text-center">ADD CLASS TO THIS SUBJECT</p>
                </div>
            </div>
            ...
            <x-splade-form :default="$subject" action="{{ route('save', $subject->id) }}" class="space-y-4">
                <div class="m-7">
                    ...
                    <div class="rounded-btn-i blue-btn-i mt-8 flex items-center justify-center">
                        <x-splade-submit :label="__('ADD CLASS')" />
                    </div>
                </div>
            </x-splade-form>
        </div>
        ...
        <div class="bg-white sm:rounded-xl relative sm:shadow-md w-full h-full flex flex-col">
            <div class="hidden sm:block px-3 border-l-4 border-l-red-500 m-7 mb-0">
                <p class="sm:text-lg text-sm text-red-500">
                    LISTS OF CLASS/ES ADDED
                </p>
            </div>
    
            <div class="sm:hidden">
                <div class="bg-red-500 w-full p-3 flex sm:px-5 items-center justify-center">
                    <p class="text-white sm:text-lg text-sm font-normal text-center">LISTS OF CLASS/ES ADDED</p>
                </div>
            </div>
            ...
            <div class="h-full w-full flex justify-center p-3 overflow-auto items-center">
                <div class="h-full w-full p-7 pt-5">
                    <div class="h-full w-full">
                        <x-splade-table class="w-full h-full mobtable" :for="$Class_With_Subs" striped>
