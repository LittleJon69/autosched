                        ...
                        @cell('action', $Stud_sched)
                            <div class="td" data-title="Actions">
                                <div class="flex gap-2">
                                    <a class="group squared-btn red-btn border" href="{{ route('coor-class-pdf', ['Course'=>$Stud_sched->studCourse, 'Year'=>$Stud_sched->studYear, 'Section'=>$Stud_sched->studSection, 'School'=>$Stud_sched->schName]) }}">
