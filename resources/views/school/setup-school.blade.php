        ...
        <div class="bg-white sm:rounded-xl relative sm:shadow-md w-full h-full flex flex-col">
            ...
            <div class="sm:hidden">
                ...
                <div class="bg-b6 w-full p-3 flex sm:px-5 items-center justify-center">
                    <p class="text-white sm:text-lg text-sm font-normal text-center">SETUP SCHOOL PROFILE</p>
                </div>
            </div>
            ...
            <div class="p-7 pt-2">
                <x-splade-form :default="$school" action="{{ route('school.store') }}">
                    <div class="">
                        ...
                        <p class="mt-2 mb-8 text-xs flex items-center justify-center sm:justify-start">Note: Red Dot " <i class="fa-solid fa-circle text-xs3 text-red-500"></i> " Means that the Field is Required.</p>
