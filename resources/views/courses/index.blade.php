                    ...
                    <x-splade-table class="w-full h-full mobtable" :for="$courses" striped>
                        ...
                        <div class="td" data-title="Actions">
                            <div class="flex gap-2">
                                <Link onclick="start()" href="{{ route('courses.edit', $course->id) }}" class="flex sm:hidden group squared-btn green-btn border">
                                    <div class="h-full w-full relative">
                                        ...
                                        <div class="absolute bottom-9 -right-4 shadow-md bg-white bg-opacity-90 rounded-md p-2 hidden w-fit group-hover:block">
                                            <p class="text-green-500 text-xs0">
                                                EDIT COURSE
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <Link class="group squared-btn red-btn border" confirm="DELETE COURSE" confirm-text="Are You Sure?" confirm-button="Confirm" cancel-button="Cancel" href="{{ route('courses.destroy', $course->id) }}" method="DELETE">
                                    <div class="h-full w-full relative">
