            ...
            <div class="h-full w-full flex justify-center xl:w-tabw">
                <div class="w-full">
                    <x-splade-table class="w-full mobtable" :for="$courses" striped>
                        @cell('action',$course)
                        <Link href="{{ route('generate',['course' => $course->courseName]) }}" confirm="GENERATE SCHEDULE" confirm-text="Are You Sure?" confirm-button="Yes" cancel-button="Cancel" class="flex group squared-btn orange-btn border w-12">
                            <div class="h-full w-full relative">
                                ...
                                <div class="absolute bottom-8 -right-4 shadow-md bg-white bg-opacity-70 rounded-md p-2 opacity-0 w-0 group-hover:opacity-100 group-hover:w-fit">
